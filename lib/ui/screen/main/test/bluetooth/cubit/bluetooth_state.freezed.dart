...
class __$$_InfoDeviceStateCopyWithImpl<$Res>
    extends _$BluetoothStateCopyWithImpl<$Res, _$_InfoDeviceState>
...
class _$_InfoDeviceState implements _InfoDeviceState {
  ...
  @override
  String toString() {
    return 'BluetoothState(isLoading: $isLoading, result: $result, isActive: $isActive, error: $error)';
  }
...
abstract class _InfoDeviceState implements BluetoothState {
