...
part of 'info_device_state.dart';
...
mixin _$InfoDeviceState {
  ...
  @JsonKey(ignore: true)
  $InfoDeviceStateCopyWith<InfoDeviceState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $InfoDeviceStateCopyWith<$Res> {
  factory $InfoDeviceStateCopyWith(
          InfoDeviceState value, $Res Function(InfoDeviceState) then) =
      _$InfoDeviceStateCopyWithImpl<$Res, InfoDeviceState>;
  @useResult
  $Res call(
...
/// @nodoc
class _$InfoDeviceStateCopyWithImpl<$Res, $Val extends InfoDeviceState>
    implements $InfoDeviceStateCopyWith<$Res> {
  _$InfoDeviceStateCopyWithImpl(this._value, this._then);
...
class __$$_InfoDeviceStateCopyWithImpl<$Res>
    extends _$InfoDeviceStateCopyWithImpl<$Res, _$_InfoDeviceState>
...
class _$_InfoDeviceState implements _InfoDeviceState {
  ...
  @override
  String toString() {
    return 'InfoDeviceState(isLoading: $isLoading, result: $result, isActive: $isActive, error: $error)';
  }
...
abstract class _InfoDeviceState implements InfoDeviceState {
